    ...
    <script>
         ...
         */
            ...
            function mapOnclick(point) {
                $("#click_lng").val(point["lng"]);
                $("#click_lat").val(point["lat"]);
                
                var tmp_href = "http://i.rgc.place.weibo.cn/rgc_tomcat/businessup?type=6&points="+point["lng"]+","+point["lat"]+"&inner_source=get_place_business";
                $('#point_click').attr('href',tmp_href); 
                _geoc.getAddress( point, function (status, result) {  
                        //alert(JSON.stringify(result));
                        if (status === 'complete' && result.info === 'OK') {
                            var address = result.regeocode.formattedAddress;
         ...
         */
            ...
            function addLbsSearchBox(point,icon_count_url,ul_id)
            {
                ...
                ShowDiv += '            <h5 class="m-text-cut" style="color: #939393;">' + point['checkin_user_num'] + ' 人  ' + point['distance'] + ' 米以内 选中:'+ point['selected'] + ' 面数据:'+ point['is_mian'] +'</h4>';
                ShowDiv += '        </div>';
                ShowDiv += '    </div>';
         ...
         */
            ...
            function changeIframe() {
                ...
                document.getElementById("test_a").href = url; 
            }  
    ...
    <div class="row" style="width:100%">
        <div class="col-md-7" style="padding:0px;"> 
            <div class="form-group form-inline" id="title" style="height:10vh;">
                ...
                <input id="click_lng" style="5vw">
                <input id="click_lat" style="5vw">
                <a target="_blank" href="" id="point_click" >逆地理编码</a>
                <a target="_blank" href="" id="test_a" >iframe</a>
